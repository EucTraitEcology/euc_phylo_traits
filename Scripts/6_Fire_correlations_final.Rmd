...
This notebook is necessary for creating Figure 6 (effect of fire response on the 4 most affected traits: MH, RBT, SLA, LA) and supplementary Tables S2.1 and S2.2 (comparison of raw data parameters for inclusion and exclusion of 10 variably sprouting taxa in 'combination resprouter' category).
