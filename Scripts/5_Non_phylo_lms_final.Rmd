...
This notebook also aims to create network diagrams and an ellipse table to represent the results and compare to the phylogenetic analysis. These correspond to Figures 4 and 5 in the manuscript and supplementary Table S7.1 (raw data for every correlation measured in this script using OLS models) and supplementary Figures S7 (Ellipse Table of Pearson's R) and S8 (Alternate versions of the networks without as many lines omitted).
